...
class Scanwords(QMainWindow):
    ...
    def change_level(self, level_func, grid_size, level):
        ...
        if level == 1:
            self.now_levels = 1
            self.set_large_image_at_position('1.jpg', 5, 4, 2, 2)
        elif level == 2:
            self.now_levels = 2
        else:
            self.now_levels = 3
    ...
    def initUI(self):
        ...
        levels_menu4 = levels_menu.addAction(QIcon('1.png'), "1 уровень")
        levels_menu4.triggered.connect(lambda: self.change_level(setup_easy, EASY_GRID_SIZE, 1))

        levels_menu5 = levels_menu.addAction(QIcon('2.png'), "2 уровень")
        levels_menu5.triggered.connect(lambda: self.change_level(setup_medium, MED_GRID_SIZE, 2))

        levels_menu6 = levels_menu.addAction(QIcon('3.png'), "3 уровень")
